...
FA = utils.open_flex('SA.pkl')  # ground truth values
FB = utils.open_flex('SB.pkl')  # ground truth values
...
all_int_me = []
sz = 5  # integration fudge factor to include spots that dont overlap perfectly with predictions
