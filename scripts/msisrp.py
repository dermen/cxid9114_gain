...
from libtbx.utils import Sorry as libtbx_utils_Sorry
...
spot_par.spotfinder.lookup.mask = "../mask/dials_mask_64panels.pkl"
...
spot_par_moder.spotfinder.lookup.mask = "../mask/dials_mask_64panels.pkl"
...
for idx in hit_idx[:N]:
    ...
    simtbx_dets = [ Detector.from_dict( {"hierarchy": dummie_hier,
                                          "panels":[p]})
                     for p in det_pans]
    ...
    try:
        ...
        orientAB.index()
    except libtbx_utils_Sorry, RuntimeError:
