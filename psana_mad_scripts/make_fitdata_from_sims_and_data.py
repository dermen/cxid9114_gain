...
if has_best:
    ...
    print best_Nmos_dom, best_Ncell_abc
...
print "Checking the edge cases, such a pain.. "
...
# double define for convenience cause sz is easier to type
