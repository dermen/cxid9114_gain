...
class Yb_scatter:
    ...
    def __init__(self, input_file="fp_fdp.npz"):
...
def main():
    en_chans = h5py.File("exper_spectra.h5", "r")["energy_bins"][()]
    output_name = "exper_spectra_sfall.h5"
    pdb_name='003_s0_mark0_001.pdb'

    Fout = []
    for i_en, en in enumerate(en_chans[:10]):
